...
# show all processes
$ sudo docker exec klt-risd-webhook-instance-prod-v3-0-3-njqt supervisorctl status
# check logs for individual processes
$ sudo docker exec klt-risd-webhook-instance-prod-v3-0-3-njqt supervisorctl tail -f http_server
$ sudo docker exec klt-risd-webhook-instance-prod-v3-0-3-njqt supervisorctl tail -f command_delegator
$ sudo docker exec klt-risd-webhook-instance-prod-v3-0-3-njqt supervisorctl tail -f build_worker:build_worker_00
$ sudo docker exec klt-risd-webhook-instance-prod-v3-0-3-njqt supervisorctl tail -f build_worker:build_worker_01
$ sudo docker exec klt-risd-webhook-instance-prod-v3-0-3-njqt supervisorctl tail -f build_worker:build_worker_02
$ sudo docker exec klt-risd-webhook-instance-prod-v3-0-3-njqt supervisorctl tail -f build_worker:build_worker_03
```
