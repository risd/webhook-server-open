...
pragma optional_param customer_id "5R4b1a1NVM2CnfaVzAGLHY";
C!
W!
# Backends

backend F_addr_storage_googleapis_com {
    .connect_timeout = 1s;
    .dynamic = true;
    .port = "80";
    ...
    .share_key = "5MtdCz1yC1JoxG5boNxoQm";
...
table redirect_one_to_one_urls {
  "www.risd.edu/summerstudies/": "https://summer.risd.edu",
  "www.risd.edu/teaching+learning-in-art+design/": "www.risd.edu/academics/teaching-learning-in-art-design/",
  "www.risd.edu/teaching-learning-in-art-design/": "www.risd.edu/academics/teaching-learning-in-art-design/",
  "www.risd.edu/textiles/": "www.risd.edu/academics/textiles/",
  "www.risd.edu/thesis/": "http://gradshow.risd.edu/",
  "www.risd.edu/tlad/": "www.risd.edu/academics/teaching-learning-in-art-design/",
  "www.risd.edu/uploadedFiles/RISD_edu/About_RISD/FAQ/fact_book_2016_160511.pdf": "http://info.risd.edu/webhook-uploads/1462988813309/fact_book_2016_160511.pdf",
  "www.risd.edu/videos/": "https://vimeo.com/risd",
  "www.risd.edu/viewbook/": "https://admissions.risd.edu/register/information_request/",
  "www.risd.edu/visit/": "www.risd.edu/about/visiting-risd/",
  "www.risd.edu/welcome/": "http://congratulations.risd.edu/",
  "www.risd.edu/wintersession/": "www.risd.edu/academics/wintersession/",
  "www.risd.edu/xyz/": "www.risd.edu/alumni/risd-xyz/",
  "www.risd.edu/xyzmail/": "www.risd.edu/alumni/risd-xyz/",
}
...
#--FASTLY RECV BEGIN
 ...
 "} ) {
  ...
  if ( table.lookup( redirect_one_to_one_urls, req.http.host req.url.path ) ) {
  if ( table.lookup( redirect_one_to_one_urls, req.http.host req.url.path ) ~ "^(http)?"  ) {
    set req.http.x-redirect-location = table.lookup( redirect_one_to_one_urls, req.http.host req.url.path );
  } else {
    set req.http.x-redirect-location = "http://" table.lookup( redirect_one_to_one_urls, req.http.host req.url.path );  
  }
  ...
  if ( req.url ~ "^/academics/painting/faculty/." ) {
  set req.http.x-redirect-location = "http://" req.http.host "/academics/painting/faculty/";
  error 301;
}

  # default conditions
  set req.backend = F_addr_storage_googleapis_com;
